...
После подключения первого ученика становятся доступны все функции: **[расписание](Занятия.md), [задания](Домашние%20задания.md), [оплаты](Оплаты.md), [статистика](Статистика.md) и балльная система [«Газики»](Газики.md)**.
...
| **📚 Домашние задания** | Проверка решений, выставление баллов, архив | ⏳ Число непроверенных работ |
...
| **⏭️ Пропущенные** | Список пропущенных занятий | Появляется только при наличии пропусков |
| **❓ Помощь** | Поддержка, база знаний | — |
| **👤 Профиль** | Тарифы, партнёрка, настройки | — |
...
* **Оценка:** Оценивается в [**Газиках**](Газики.md) (0–50). Уведомление мгновенно приходит ученику и родителю.
