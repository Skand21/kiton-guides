...
Откройте "Ученики" и нажмите "Добавить ученика". В веб-кабинете так создаётся виртуальная карточка: ученик ещё может не входить в Китон, но вы уже ведёте расписание, ДЗ, оплаты и прогресс. Укажите имя, предмет, ставку, длительность занятия и ссылки, которые будете использовать на уроках.
